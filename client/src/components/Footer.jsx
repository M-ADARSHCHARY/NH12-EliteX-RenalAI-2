      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-xl font-bold">Renal AI</h3>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Advanced AI-powered kidney stone detection and analysis system. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition duration-200">Bug Reports</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2025 Renal AI. All rights reserved.
          </div>
          <div className="flex items-center space-x-6 text-sm text-gray-400">
            ...
            <a href="#" className="hover:text-white transition duration-200">Cookie Policy</a>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="bg-yellow-900 bg-opacity-50 border border-yellow-600 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h5 className="text-yellow-400 font-semibold text-sm mb-1">Medical Disclaimer</h5>
                <p className="text-yellow-200 text-xs leading-relaxed">
                  This AI system is designed to assist healthcare professionals and is not intended to replace professional medical judgment. 
                  All results should be reviewed by qualified medical personnel before making any clinical decisions.
                </p>
              </div>
            </div>
          </div>
